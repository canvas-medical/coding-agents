"""
Anthropic Claude LLM wrapper for Gradient plugin.

This module provides a lightweight interface to Anthropic's Claude API,
designed for generating clinical recommendations.
"""
...
class LlmAnthropic:
    """Anthropic Claude LLM client for clinical recommendation generation."""
