...
8. **Material-style card language.** 4px radius, layered `box-shadow` for elevation, consistent neutral/accent palette. Tap-to-expand cards get a visible, rotating chevron.
